...
`POST /agent/query`: it searches federated PeerTube videos via SepiaSearch (sepiasearch.org), returned as media embryos (thumbnail, source url, license) that render as image / audio / video cards in the Emquest UI.
